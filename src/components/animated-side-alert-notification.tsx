  ...
  return (
    ...
    >
      <Alert variant="default" className="shadow-lg dark:bg-gray-900 dark:border-gray-700">
        ...
        <AlertTitle className="flex justify-between items-center dark:text-white text-red-400">
          No refunds policy
        ...
        <AlertDescription className="mt-2 dark:text-white">
          <p className="mb-2">we regret to inform you that refunds are not available for this purchase for any queries please feel free to contact us at recursekmit@gmail.com.Thank you for your understanding</p>
          <Link href="/ps">
