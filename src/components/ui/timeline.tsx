  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10 pb-0">
        <h2 className="text-4xl sm:text-6xl font-bold relative z-10 bg-clip-text text-transparent bg-gradient-to-b from-neutral-600 to-neutral-200  my-8 text-center">
          Timeline
        </h2>
